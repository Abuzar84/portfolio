...
import { Mail, Lock, Eye, EyeOff, ArrowRight, ShoppingCart, CheckCircle, Github, Twitter } from 'lucide-react';
                ...
                <div className="w-full md:w-1/2 bg-gradient-to-br from-purple-600 to-blue-600 p-12 text-white flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10 my-12">
                        ...
                        <p className="text-purple-100 text-lg mb-8">
                            Discover the latest trends, exclusive deals, and a personalized shopping experience just for you.
                        </p>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center space-x-3">
                                ...
                                <span className="text-purple-100">Exclusive member-only deals</span>
                            </div>
                            <div className="flex items-center space-x-3">
                                <div className="p-1 bg-white/20 rounded-full">
                                    <CheckCircle className="w-5 h-5 text-white" />
                                </div>
                                <span className="text-purple-100">Fast and secure checkout</span>
                            </div>
                            <div className="flex items-center space-x-3">
                                <div className="p-1 bg-white/20 rounded-full">
                                    <CheckCircle className="w-5 h-5 text-white" />
                                </div>
                                <span className="text-purple-100">24/7 dedicated support</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-md mx-auto w-full">
                        <div className="text-center mb-10">
                            ...
                            <p className="text-gray-500">
                                ...
                                <Link href="/ecommerce/signup" className="text-purple-600 font-semibold hover:text-purple-700 transition-colors">
                                    Create one now
                                </Link>
                            </p>
                        </div>
